...
export default function DraftsPanel({ drafts, onLoad, onDelete, onStar }: DraftsPanelProps) {
        ...
        <div style={{ display: "flex", gap: "6px", flexShrink: 0, marginTop: "2px" }}>
          <button
            ...
            style={{
              ...
              fontSize: "14px", color: draft.starred ? "#C9A84C" : "#888578",
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column" }}>
      ...
      {starred.length > 0 && (
        <>
          <div style={{ fontSize: "9px", color: "#C9A84C", letterSpacing: "0.1em", textTransform: "uppercase", padding: "4px 16px 2px", fontWeight: 600 }}>
            ★ Starred
          </div>
